...
class DirectAnswerModule:
    ...
    def extract(self, llm_output: str) -> str:
        ...
        if paragraphs and paragraphs[0]:
            ...
            direct_answer = self._deduplicate_candidates(direct_answer)
    ...
    def _deduplicate_candidates(self, text: str) -> str:
        """
        Remove duplicate candidate mentions from text.
        ...
        Args:
            text: Text with potential duplicate candidates
        ...
        for match in matches:
            ...
            if cv_id in seen_cv_ids:
                ...
                logger.info(f"[DIRECT_ANSWER] Removing duplicate: {name} ({cv_id})")
            else:
