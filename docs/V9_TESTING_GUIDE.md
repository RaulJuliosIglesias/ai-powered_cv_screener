...
Guía práctica para testear todas las features implementadas en V9.
...
### Endpoints de V9 disponibles:
```bash
# Verificar que V9 está activo
...
```bash
# Filtrar logs de V8/V9 features
grep -E "HYBRID_SEARCH|SEMANTIC_CACHE|FALLBACK|EXPORT|SCREENING|TYPESCRIPT" backend.log
```
...
pytest tests/ -v -k "export or cache or hybrid"
...
| CI/CD fails | Check: `.github/workflows/` |
...
| Cloud Parity | 60% | 100% | +66% |
| Pre-commit Hooks | None | 8 | ✅ |
| Quality Gates | Manual | Auto | ✅ |
